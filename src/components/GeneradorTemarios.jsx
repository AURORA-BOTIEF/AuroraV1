...
function GeneradorTemarios() {
  ...
  const handleGenerar = async (nuevosParams = params) => {
    ...
    // --- INICIA AJUSTE ---
    // Se quitan !nuevosParams.nombre_preventa y !nuevosParams.asesor_comercial de la validación
    if (!nuevosParams.tema_curso || !nuevosParams.tecnologia || !nuevosParams.sector) {
      // Se actualiza el mensaje de error para reflejar los nuevos campos requeridos
  ...
  // --- AJUSTE: CÁLCULO DE HORAS TOTALES ---
