                        ...
                        <div className="form-section">
                            ...
                            <div className="form-group">
                                ...
                                >
                                    ...
                                    <option value="gpt-image-2">OpenAI GPT Image 2 (API Images — calidad alta, requiere clave OpenAI)</option>
                                </select>
                                <small className="form-hint">
                                    Gemini 2.5: ~7s/imagen, menor costo | Gemini 3: ~25s/imagen (máx 4 por lote) | GPT Image 2: vía API de OpenAI, límites por tier (~13s entre imágenes en backend por defecto)
                                </small>
                            </div>
                        </div>
