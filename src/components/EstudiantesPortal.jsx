...
function EstudiantesPortal() {
    ...
    const initialTab = queryParams.get('tab') || 'cursos';
    ...
    const viewPresentation = (folder) => {
        navigate(`/presentaciones/viewer/${encodeURIComponent(folder)}?returnTo=/mis-cursos?tab=presentaciones`);
    };
    ...
    return (
        <div className="estudiantes-portal">
            <div className="estudiantes-header">
                ...
                <p className="subtitle">Aquí puedes acceder a los cursos y presentaciones que te han sido asignados</p>
            </div>
