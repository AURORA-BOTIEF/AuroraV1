...
import EditorDeTemario_KNTR from "./EditorDeTemario_KNTR";
...
const obtenerVersionApi =
  "https://eim01evqg7.execute-api.us-east-1.amazonaws.com/versiones/versiones-KNTR?id={cursoId}&version={versionId}";
const listarApiUrl =
  "https://eim01evqg7.execute-api.us-east-1.amazonaws.com/versiones/versiones-KNTR/list";
...
const handleListarVersiones = async () => {
  ...
  const handleEditarVersion = (v) => {
    ...
    navigate(`/editor-KNTR/${v.cursoId}/${v.versionId}`);
  };
    ...
    <div className="contenedor-generador">
      <div className="card-generador">
        ...
        <div className="header-practico" style={{ marginBottom: '15px' }}>
          <h2>Generador de Temarios KNTR</h2>
        </div>
