...
function GeneradorTemarios_KNTR() {
  ...
  const handleListarVersiones = async () => {
    setVersiones([
      {
        nombre_curso: "KNTR DE IA CON CHATGPT",
        tecnologia: "OpenAI",
        asesor_comercial: "Lezly Durán",
        fecha_creacion: new Date().toISOString(),
        autor: "david.marquez@netec.com",
      },
    ]);
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <input
              ...
              placeholder="Ej: BANCO DE CREDITO DEL PERU-BCP Python"
            />
          </div>
          ...
          <div className="form-group">
            <label>Duración por sesión (3–7 horas) *</label>
            <div className="slider-container">
              <input
                type="range"
                min="1"
